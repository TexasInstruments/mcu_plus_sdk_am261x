...
MEMORY
{
    ...
    MSRAM_0   : ORIGIN = 0x70002100 , LENGTH = 0x40000 
    MSRAM_HSMRT   : ORIGIN = 0x70042100 , LENGTH = 0x30000 
    MAILBOX_HSM   : ORIGIN = 0x44000000 , LENGTH = 0x3CE 
    MAILBOX_R5F   : ORIGIN = 0x44000400 , LENGTH = 0x3CE 
    FLASH_BOOT_REGION_INFO   : ORIGIN = 0x80080000 , LENGTH = 0x1000 LAST (__TI_SBL_FLASH_BOOTINFO_SECTOR_START)
